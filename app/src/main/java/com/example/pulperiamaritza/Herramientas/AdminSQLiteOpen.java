...
public class AdminSQLiteOpen extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase BaseDatos) {
        ...
        BaseDatos.execSQL("CREATE TABLE Sucursales (SucID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, SucCiudad TEXT NOT NULL);");
        BaseDatos.execSQL("CREATE TABLE VentasEncabezado (VntID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, VntFecha TEXT NOT NULL, VntBolsas INTEGER NOT NULL, UsuID INTEGER NOT NULL, SucID INTEGER NOT NULL, FOREIGN KEY(UsuID) REFERENCES Usuarios(UsuID), FOREIGN KEY(SucID) REFERENCES Sucursales(SucID));");
        BaseDatos.execSQL("CREATE TABLE VentasDetalle (VntID INTEGER NOT NULL, PrdID INTEGER NOT NULL, PrdNombre TEXT NOT NULL, PrdPrecio REAL NOT NULL, PrdCantidad INTEGER NOT NULL, PrdTipo TEXT NOT NULL, FOREIGN KEY(VntID) REFERENCES VentasEncabezado(VntID), FOREIGN KEY(PrdID) REFERENCES Productos(PrdID), PRIMARY KEY(VntID, PrdID));");
