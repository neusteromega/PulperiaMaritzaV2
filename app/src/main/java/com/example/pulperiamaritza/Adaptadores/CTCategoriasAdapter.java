...
public class CTCategoriasAdapter extends RecyclerView.Adapter<CTCategoriasAdapter.RecyclerHolder> implements View.OnClickListener {
    ...
    public CTCategoriasAdapter(List<CTCatPrvItemsModel> items) {
        this.items = items;
    }
    ...
    public RecyclerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.items_ctcategorias, parent, false); //Inflamos la vista que utilizaremos para las tarjetas del RecyclerView
    ...
    public void onBindViewHolder(@NonNull RecyclerHolder holder, int position) {
        ...
        holder.imgCategoria.setImageResource(item.getImagen());
        holder.tvCategoria.setText(item.getNombre());
    }
    ...
    public static class RecyclerHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerHolder(@NonNull View itemView) { //Método Constructor que recibe un View
            ...
            imgCategoria = itemView.findViewById(R.id.imgCTCategoria);
            tvCategoria = itemView.findViewById(R.id.lblCTCategoria);
        }
    }
}