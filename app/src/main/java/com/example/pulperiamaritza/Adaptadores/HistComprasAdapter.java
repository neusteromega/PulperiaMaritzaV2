...
public class HistComprasAdapter extends RecyclerView.Adapter<HistComprasAdapter.RecyclerHolder> implements View.OnClickListener {
    private List<HistComprasItemsModel> items; //Creamos una lista de tipo HistVentasItemsModel
    ...
    public HistComprasAdapter(List<HistComprasItemsModel> items) { //Método Constructor en el cual inicializamos la lista "items"
        this.items = items;
    }
    ...
    public void onBindViewHolder(@NonNull HistComprasAdapter.RecyclerHolder holder, int position) {
        HistComprasItemsModel item = items.get(position); //Creamos una lista de tipo HistVentasItemsModel llamada "item" la cual igualamos a la otra lista "items" extrayendo posición por posición
    ...
    public static class RecyclerHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerHolder(@NonNull View itemView) { //Método Constructor que recibe un View
            ...
            tvCodigo = itemView.findViewById(R.id.lblCodigoVentaHist);
            tvFecha = itemView.findViewById(R.id.lblFechaVentaHist);
            tvTotal = itemView.findViewById(R.id.lblTotalVentaHist);
        }
    }
}
